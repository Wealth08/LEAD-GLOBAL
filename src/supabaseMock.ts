...
export const dbService = new SupabaseService();ium', name: 'Titanium Plan', price: 120, dailyEarning: 4, description: 'Earn $4 daily Mon–Fri. Withdrawal unlocks after $120 in plan earnings.' },
  platinum: { id: 'platinum', name: 'Platinum Plan', price: 240, dailyEarning: 8, description: 'Earn $8 daily Mon–Fri. Withdrawal unlocks after $240 in plan earnings.' },
};
